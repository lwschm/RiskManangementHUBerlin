...
# Check if each station has data from 1995 onwards and hasfile is TRUE
...
# Filter stations that have data from 1995 onwards and hasfile is TRUE
...
write.xlsx(historical_stations, "Station IDs", row.names = FALSE)